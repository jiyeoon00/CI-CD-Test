package com.example.cicdTest.external.client.aws;
...
public class S3Service {
    ...
    public List<String> uploadImages(List<MultipartFile> multipartFileList, String folder) {
        return multipartFileList.stream().map(multipartFile -> uploadImage(multipartFile, folder)).collect(Collectors.toList());
    }
